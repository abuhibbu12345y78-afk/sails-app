...
begin
  ...
  loop
    ...
    if v_sale_normal_units != v_curr_sale.normal_commission_units or v_sale_full_units != v_curr_sale.full_commission_units then
       update public.sales set
         ...
         net_collection_paise = (unit_selling_price_paise * quantity) - ((v_sale_normal_units * normal_commission_paise_snapshot) + (v_sale_full_units * full_commission_paise_snapshot)),
         updated_at = now()
